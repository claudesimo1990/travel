                ...
                <div class="bg-white py-6 px-4 sm:p-6">
                    <div>
                        <h2 id="payment-details-heading"
                            class="text-lg font-medium leading-6 text-gray-900">@lang('profile.home')</h2>
                    ...
                    <div class="mt-6 grid grid-cols-4 gap-6">
                        ...
                        <div class="col-span-4 sm:col-span-1">
                            <label for="security-code" class="flex items-center text-sm font-medium text-gray-700">
                                ...
                                <svg class="ml-1 h-5 w-5 flex-shrink-0 text-gray-300" xmlns="http://www.w3.org/2000/svg"
            ...
            <div class="shadow sm:overflow-hidden sm:rounded-md">
                <div class="space-y-6 bg-white py-6 px-4 sm:p-6">
                        ...
                        <div class="relative -space-y-px rounded-md bg-white">
                            <label
                                ...
                                <span id="pricing-plans-0-description-1"
                                      class="ml-6 pl-1 text-sm md:ml-0 md:pl-0 md:text-right">Up to 5 active job postings</span>
                            </label>
                            <label
                                ...
                                <span id="pricing-plans-1-description-1"
                                      class="ml-6 pl-1 text-sm md:ml-0 md:pl-0 md:text-right">Up to 25 active job postings</span>
                            </label>
                            <label
                                ...
                                <span id="pricing-plans-2-description-1"
                                      class="ml-6 pl-1 text-sm md:ml-0 md:pl-0 md:text-right">Unlimited active job postings</span>
                            </label>
                        </div>
                    </fieldset>
                    ...
                    <div class="flex items-center">
                        <button type="button"
                                class="bg-gray-200 relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-gray-900 focus:ring-offset-2"
                        ...
                        <div class="overflow-hidden border-t border-gray-200">
                            <table class="min-w-full divide-y divide-gray-200">
                                ...
                                <tr>
                                    ...
                                    <td class="whitespace-nowrap px-6 py-4 text-sm text-gray-500">Business Plan - Annual
                                        Billing
                                    </td>
