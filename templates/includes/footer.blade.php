<footer class="bg-gray-800 mt-32" aria-labelledby="footer-heading">
    <h2 id="footer-heading" class="sr-only">Colissend</h2>
    <div class="mx-auto max-w-7xl py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
        <div class="pb-8 xl:grid xl:grid-cols-5 xl:gap-8">
            <div class="grid grid-cols-2 gap-8 xl:col-span-4">
                <div class="md:grid md:grid-cols-2 md:gap-8">
                    <div>
                        <h3 class="text-base font-medium text-white">Pages principales</h3>
                        <ul role="list" class="mt-4 space-y-4">
                            <li>
                                <a href="#" class="text-base text-gray-300 hover:text-white">Accueil</a>
                            </li>

                            <li>
                                <a href="#" class="text-base text-gray-300 hover:text-white">Annonces</a>
                            </li>

                            <li>
                                <a href="#" class="text-base text-gray-300 hover:text-white">Poster un Trajet</a>
                            </li>

                            <li>
                                <a href="#" class="text-base text-gray-300 hover:text-white">Expedier un colis</a>
                            </li>
                        </ul>
                    </div>
                    <div class="mt-12 md:mt-0">
                        <h3 class="text-base font-medium text-white">Contactez nous</h3>
                        <ul role="list" class="mt-4 space-y-4">
                            <li>
                ...
                <div class="md:grid md:grid-cols-2 md:gap-8">
                    <div>
                        <h3 class="text-base font-medium text-white">Colissend</h3>
                        <ul role="list" class="mt-4 space-y-4">
                            <li>
                                <a href="#" class="text-base text-gray-300 hover:text-white">Qui sommes nous?</a>
                            </li>
            ...
            <div class="mt-12 xl:mt-0">
                ...
                <form class="mt-4 sm:max-w-xs">
                    <fieldset class="w-full">
                        ...
                        <div class="relative">
                            <form action="">
                                <select id="language" name="lang" class="block w-full appearance-none rounded-md border border-transparent bg-gray-700 bg-none py-2 pl-3 pr-10 text-base text-white focus:border-white focus:outline-none focus:ring-white sm:text-sm"
                                        onchange="this.form.submit()">
                                    <option @if(request()->get('lang') == 'en') selected @endif value="en">English</option>
                                    <option @if(request()->get('lang') == 'de') selected @endif value="de">German</option>
                                    <option @if(request()->get('lang') == 'fr') selected @endif value="fr">French</option>
                                </select>
                            </form>
        ...
        <div class="mt-8 border-t border-gray-700 pt-8 md:flex md:items-center md:justify-between">
            ...
            <p class="mt-8 text-base text-gray-400 md:order-1 md:mt-0">© {{ now()->format('Y') }} Copyright:  <a href="{{ route('app.home') }}" class="text-success">colissend.com</a></p>
        </div>
    </div>
</footer>
